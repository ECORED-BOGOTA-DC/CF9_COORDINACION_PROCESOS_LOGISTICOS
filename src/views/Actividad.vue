  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Modelo logístico VMI
        p.mb-4 Identificar elementos clave para implementar con éxito el modelo VMI, optimizando control de inventarios y mejorando eficiencia operativa mediante sincronización de datos y colaboración con proveedores.
